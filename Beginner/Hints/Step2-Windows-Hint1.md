...
### Windows
1.  Use Hashcat and the password files available under lab-PasswordCracking/.Storage (Don't forget to use your web brower and check out [Beginner/Downloads](https://github.com/JonZeolla/lab-PasswordCracking/tree/master/Beginner/Downloads)) to crack the first dump.  
...
2.  Use Hashcat and the password files available under lab-PasswordCracking/.Storage (Don't forget to use your web brower and check out [Beginner/Downloads](https://github.com/JonZeolla/lab-PasswordCracking/tree/master/Beginner/Downloads)) to reconfigure and crack the second dump.  
